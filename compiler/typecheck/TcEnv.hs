...
tcExtendKindEnv2 :: [(Name, Weighted TcTyThing)] -> TcM r -> TcM r
...
tcAddDataFamConPlaceholders inst_decls thing_inside
  = tcExtendKindEnv2 [ (con, Weighted Omega (APromotionErr FamDataConPE)) -- TODO: arnaud: unsure. Probably correct: when type is unclear, assume Omega.
...
tcAddPatSynPlaceholders pat_syns thing_inside
  = tcExtendKindEnv2 [ (name, Weighted Omega (APromotionErr PatSynPE)) -- TODO: arnaud: see just above
