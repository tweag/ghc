    ...
    tc_super (sc_pred, n)
      = do { (sc_implic, ev_binds_var, sc_ev_tm)
           ...
           ; let sc_top_ty = mkInvForAllTys tyvars $
                 ...
                 sc_top_id = mkLocalId sc_top_name (Usages zeroUA) sc_top_ty
                 export = ABE { abe_ext  = noExtField
                              , abe_wrap = idHsWrapper
                              , abe_poly = sc_top_id
                              , abe_mono = sc_ev_id
...
tcMethodBodyHelp hs_sig_fn sel_id local_meth_id meth_bind
  ...
  = do { let ctxt = FunSigCtxt sel_name True
       ...
       ; let inner_meth_id  = mkLocalId inner_meth_name (Usages zeroUA) sig_ty
...
mkMethIds clas tyvars dfun_ev_vars inst_tys sel_id
  = do  { poly_meth_name  <- newName (mkClassOpAuxOcc sel_occ)
        ...
        ; let poly_meth_id  = mkLocalId poly_meth_name  (Usages zeroUA) poly_meth_ty
              local_meth_id = mkLocalId local_meth_name (Usages zeroUA) local_meth_ty
