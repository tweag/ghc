...
tyConAppArgs_maybe (FunTy _ arg res)  = Just [arg,res] -- FIXME: arnaud: I don't see how this could not be a source of bugs. Maybe just remove this function altogether.
