...
ppr_co ctxt_prec (IfaceFunCo r cow co1 co2) = text "IfaceFunCo ((" <> ppr_role r <> text "),(" <> ppr_co ctxt_prec cow <> text "),(" <> ppr_co ctxt_prec co1 <> text "),(" <> ppr_co ctxt_prec co2 <>  text "))"
